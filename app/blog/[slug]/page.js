export default async function Page({ params }) {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg mt-5">
      ...
      <p className="text-base mb-2 border-l-4 border-gray-500 pl-3 italic">
        &quot;{blog.discripton}&quot;
      </p>
      <p className="text-gray-500 text-sm mb-4">
        by <span className="font-medium font-serif italic">{blog.author}</span>{" "}
        | <span className="font-medium">{blog.datePublished}</span>
      </p>
      <div
